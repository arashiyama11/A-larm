...
class PersonaRepositoryImpl @Inject constructor() : PersonaRepository {
    ...
    override suspend fun setCurrent(userId: UserId, persona: AssistantPersona) {
